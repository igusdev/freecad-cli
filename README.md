...
```bash
docker run --rm -v $(pwd):/data ghcr.io/igusdev/freecad-cli:1.1.3 FreeCADCmd <command>
```

AppImage flavor:

```bash
docker run --rm -v $(pwd):/data ghcr.io/igusdev/freecad-cli:appimage-1.1.3 freecad --console <command>
```
